...
urlpatterns = [
    ...
    path(
        '<int:campaign_pk>/chapter/<int:chapter_pk>/',
        views.CampaignDetail.as_view(),
        name='campaign_detail',
    ),
    path(
        '<int:campaign_pk>/chapter/<int:chapter_pk>/section/<int:section_pk>/',
        views.CampaignDetail.as_view(),
        name='campaign_detail',
    ),
    ...
    path(
        '<int:campaign_pk>/chapter/create/',
        views.ChapterCreate.as_view(),
        name='chapter_create',
    ),
    path(
        '<int:campaign_pk>/chapter/<int:chapter_pk>/section/create/',
        views.SectionCreate.as_view(),
        name='section_create',
    ),

    path(
        '<int:campaign_pk>/edit/',
        views.CampaignUpdate.as_view(),
        name='campaign_update',
    ),
    path(
        '<int:campaign_pk>/chapter/<int:chapter_pk>/edit/',
        views.ChapterUpdate.as_view(),
        name='chapter_update',
    ),
    path(
        '<int:campaign_pk>/chapter/<int:chapter_pk>/section/<int:section_pk>/edit/',
        views.SectionUpdate.as_view(),
        name='section_update',
    ),

    path(
        '<int:campaign_pk>/print/',
        views.campaign_print,
        name='campaign_print',
    ),
    path('import/<uuid:uuid>/',
